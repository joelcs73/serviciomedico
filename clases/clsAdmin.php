...
class clsAdmin{
	...
	public function devuelveMenu(){
		...
		$prefijo = "";
		while($datMenu=mysqli_fetch_assoc($qryMenu)){
			...
			// echo '<li class="nav-item dropdown"><a class="dropdown-item" id="'.$datMenu["idDiv"].'" href="index.php?p='.$datMenu["paginaHref"].'"><span class="'.$datMenu["iconoDelMenu"].'" aria-hidden="true"></span> '.$datMenu["tituloMenu"].'</a></li>';
