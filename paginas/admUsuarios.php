...
<!--  			<div class="col-sm-11">
 			...
 			<div class="col-md-12 offset-md-11">
 				<button type="button" class="btn btn-success btn-sm botn" id="btnAgregar" data-toggle="modal" data-target="#modalNuevoUsuario"><span class="fa fa-plus" aria-hidden="true"></span></button>
 			</div>
 		</div>
 	</nav>
