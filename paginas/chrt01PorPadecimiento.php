...
<input id="dataLabelsPorPadecimiento" class="col" style="display:none ">
<input id="dataPorPadecimiento" class="col" style="display:none " >

<canvas class="my-4" id="chrtPorPadecimientos" width="700" height="380"></canvas>
    ...
    $.ajax({
      ...
      url : "procesos/dataSet01GraficaPorPadecimiento.php",
      global:false,
      type:"POST",
      dataType:"html",
      async:true,
      ...
      success: function(informacion){
        ...
        $("#dataLabelsPorPadecimiento").val(array[0]);
        $("#dataPorPadecimiento").val(array[1]);

        var ctxPadecimiento = document.getElementById("chrtPorPadecimientos");
        var dsEtiq = JSON.parse($("#dataLabelsPorPadecimiento").val());
        var dsDatos = JSON.parse($("#dataPorPadecimiento").val());
        var chrtPorPadecimientos = new Chart(ctxPadecimiento, {
          type: 'pie',
          data: {
            labels: dsEtiq,
            datasets: [{
